...
<script type="text/javascript">
    ...
    function ques_Load() {
        ...
        function getOID(res) {
            ...
            QuesNum = parseInt(OID);//OIDは0-29なので、今何問目？的な奴には1-30に調整
        }
        myCheck2(0);
        //===================
    }
    ...
    function Button2_Click() {
        ...
        document.getElementById("number").innerHTML = "<b>" + QuesNum + "/105<b>";
    ...
    function ButtonM_Click() {
        ...
        for (i = 0; i <= Mylabels2.length - 1; i++) {
            HearingHtml += "<input name=\"HearingCheck\" id=\"select" + i + "\" value=\"" + i + "\" type=\"checkbox\"><label for=\"select" + i + "\">"
                    + Mylabels_ea[i].innerHTML + "</label>";
        }
        HearingHtml += "</div><textarea id='comments' cols='50' rows='2' style=\" position:absolute;left:0;top:40;display:none; \">自由にご記入ください。</textarea></form>";
    ...
    function print_answer() {
        ...
        var $params = 'param1=' + encodeURIComponent($QAData["WID"])
                              ...
                              + '&param8=' + encodeURIComponent($QAData["comments"]);
    ...
    function Button5_Click() {
        ...
        for (i = 0; i < MyTag.length; i++) {
            if (MyTag[i].checked) {
                if (num == 0) chkvalue += MyTag[i].value;
        ...
        YAHOO.util.Dom.setStyle("comments", "display", "none");
        YAHOO.util.Dom.setStyle("hearing", "display", "none");
...
<input type = "button"
    ...
    style="width:80px;height:30px;position:absolute;left:600px;top:400px;display:none"/>
</form>
...
<input type = "button"
    ...
    style="width:80px;height:30px;position:absolute;left:750px;top:260px;display:none"/>
</form>
...
<input type = "button"
    ...
    style="width:75px;height:33px;position:absolute;left:768px;top:238px;display:none"/>
...
<input type = "button"
    ...
    style="width:75px;height:20px;position:absolute;left:768px;top:293px;background-color:pink;display:none"/>
...
<div id = "RichTextBox3" style="background-color:#a1ffa1;position:absolute;
     left:670;top:273;width:80;height:34;border-style:inset;display:none">正誤を表示</div>

<!--解答時間-->
<div id = "TextBox1"  style="background-color:#a1ffa1;position:absolute;
     left:670;top:240;width:80;height:23;border-style:inset;display:none">解答時間</div>

<!--機能説明-->
<div id = "Label2" style="position:absolute;
     left:12;top:530;width:300;height:50;font-size:12;background-color:#ffa500;">
         *操作説明</br>
        </br>
...
<div id = "answer" style="z-index=10;padding: 10px; border: 2px solid #333333;position:absolute;
    left:12;top:160;width:700;height:20;font-size:12;"></div>
...
<div id = "question" style="padding: 10px; border: 2px solid #333333;position:absolute;
    left:12;top:90;width:700;height:20;font-size:12;"></div>

<!--ヒアリング機能-->
<font id="hearing2" color="red" style="position:absolute;left:12;top:240;display:none"><b>迷った単語をクリックしてください。</b></font>

<div id = "hearing" style="padding: 10px; border: 2px solid #333333;position:absolute;
    left:12;top:260;width:700;height:20;font-size:12;display:none;background-color: #f00">
</div>
...
<div id="Fixmsg" style="position:absolute;
     left:320;top:530;width:200;height:50;font-size:12;background-color:#ffa500;display:block">-情報-</div>
...
<div id="number" style="position:absolute;
     left:768;top:10;width:80;height:18;font-size:18;color:red;display;:none"></div>
...
<option value="choose" selected="selected">迷い度を選択してください</option>
