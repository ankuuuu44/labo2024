u7nnnnnnnn<!DOCTYPE html PUBLIC "-//W3c//DTD HTML 4.01 Transitional//EN">
<?php
/**
...
var CorrectRank = 0; //同じ属性の人数
var ResRank = 0;  //属性の人のうちでの順位
...
var TestContent = new Array(11); 
TestContent[10]=<?php echo $_SESSION["qtxt10"]; ?>;
//alert (TestContent[10]);
TestContent[1]=<?php echo $_SESSION["qtxt1"]; ?>;
TestContent[2]=<?php echo $_SESSION["qtxt2"]; ?>;
TestContent[3]=<?php echo $_SESSION["qtxt3"]; ?>;
TestContent[4]=<?php echo $_SESSION["qtxt4"]; ?>;
TestContent[5]=<?php echo $_SESSION["qtxt5"]; ?>;
TestContent[6]=<?php echo $_SESSION["qtxt6"]; ?>;
TestContent[7]=<?php echo $_SESSION["qtxt7"]; ?>;
TestContent[8]=<?php echo $_SESSION["qtxt8"]; ?>;
TestContent[9]=<?php echo $_SESSION["qtxt9"]; ?>;
...
new Ajax.Request(URL + 'correct.php',
{
	...
	function getaca(res){
		...
		function getara(res){
			...
			//----------------------
			var $rank = "b";
			var $AllPer = AllCorrectAns / AllResAns;
...
function setques(){
	Fixmsg.innerHTML = "-情報-";
	myCheck(0);
	//alert($TestContent[QNumber]);
	$Ques_Num = TestContent[QNumber]; //決められた問題を出題
	QNumber += 1;
...
function getResponse(req)
{
	...
	$params = 'param1=' + encodeURIComponent($Ques_Num)
		...
		new Ajax.Request(URL + 'dbsyori.php', //php呼び出し
		{
			method: 'get',
			onSuccess: getFix,
			onFailure: getError,
	...
	new Ajax.Request(URL + 'tmpfile.php',
{
	...
	var $rank = "b";
	var $AllPer = AllCorrectAns / AllResAns;
	var $params = 'param1=' + encodeURIComponent($rank);
	new Ajax.Request(URL + 'rank.php',
	{
		method: 'get',
		onSuccess: getrankc,
