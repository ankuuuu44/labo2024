...
<script type="text/javascript">
    ...
    function Button1_Click() {
        ...
        //YAHOO.util.Dom.setStyle("answer", "display", "none");
        ...
        new Ajax.Request(URL + 'tmpfile.php',
    {
        ...
        //ヒアリング機能
        /*
        document.getElementById("hearing").innerHTML = "<form name=\"Hearing\" action=\"#\">";
        for (i = 0; i <= Mylabels2.length - 1; i++) {
            document.getElementById("hearing").innerHTML += "<div class=\"check\"><input name=\"check[]\" id=\"select" + (i + 1) + "\" value=\"" + (i + 1) + "\" type=\"checkbox\"><label for=\"select" + (i + 1) + "\">"
            + Mylabels_ea[i].innerHTML + "</label></div> ";
        }
        document.getElementById("hearing").innerHTML += "</form>";
        */
    ...
    function Button2_Click() {
        ...
        if (AID == 30) {
            ...
            alert("一度右下の終了ボタンを押して書き込みを行ってください。(現在" + AID + "問終了)");
            return;
        }
        ...
        document.getElementById("Button2").disabled = true; //次へ
        document.getElementById("Buttonl").disabled = true; //終了
        ...
        YAHOO.util.Dom.setStyle("QuesLevel", "display", "none"); //自信度
    ...
    function ButtonM_Click() {
        print_answer();
        //alert("aaaaa");
        //document.getElementById("Fixmsg").innerHTML += "<br><br>check:"+document.Hearing.check.join(',');
...
<body onLoad = "ques_Load()" onMouseDown = "Form1_MouseDown()" onMouseUp = "Form1_MouseUp()">
