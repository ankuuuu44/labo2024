...
<script type="text/javascript">
    ...
    function ques_Load() {
        ...
        function getOID(res) {
            ...
            QuesNum = parseInt(OID) + 1;//OIDは0-29なので、今何問目？的な奴にはインクリメントして1-30に調整
        }
        myCheck2(0);
        //===================
    }
    ...
    function ButtonM_Click() {
        ...
        //125行目に frag = 0;
        //if(悩み度=1|2){「ヒアリングチェックボックスと自由記述欄」、frag = 1;}
...
<input type = "button"
    ...
    style="width:80px;height:30px;position:absolute;left:750px;top:470px;display:none"/>
</form>
...
<input type = "button"
    ...
    style="width:75px;height:20px;position:absolute;left:768px;top:655px;background-color:pink;display:none"/>
...
<font color="red" style="position:absolute;left:12;top:220">単語退避レジスタ</font>
...
<!--ヒアリング機能-->
<font id="hearing2" color="red" style="position:absolute;left:12;top:450;display:none"><b>迷った単語をクリックしてください。</b></font>
<div id = "hearing" style="padding: 10px; border: 2px solid #333333;position:absolute;
    left:12;top:470;width:700;height:20;font-size:12;display:none;background-color: #f00">
</div>
...
<option value="choose" selected="selected">悩み度を選択してください</option>
<option value="level1">・ほとんど悩まなかった</option>
<option value="level2">・少し悩んだ</option>
<option value="level3">・かなり悩んだ</option>
