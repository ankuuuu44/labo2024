...
if(parseInt(t_point[m]) == parseInt(t_point[m+1])){m = m+1;}
    ...
    function DrawLine() {
        ...
        else if (t > 40000 && t <= 50000) { jg.setColor("pink"); }
    ...
    jQuery(function () {
        jQuery('#jquery-ui-slider').slider({
            ...
            slide: function (event, ui) {
                ...
                //jQuery('#jquery-ui-slider-value').val("500" + 'ms');
                slider = ui.value;
            }
        });
        jQuery('#jquery-ui-slider-value').val(jQuery('#jquery-ui-slider').slider('value') + 'ms');
        //jQuery('500').val(jQuery('500').slider('500') + 'ms');
    });
