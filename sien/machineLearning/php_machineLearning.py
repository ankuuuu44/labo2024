        ...
        for train_index,test_index in kf.split(X_data):
            ...
            if 2 in test_y:
                ...
                f1_y = f1_score(test_y, pred, pos_label=2)
                 ...
                 print(f"Fold {fold}: Class 2 not found in y_test, skipping precision, recall, f1 for class 2")
            ...
            if 4 in test_y:
                ...
                print(f"Fold {fold}: Class 4 not found in y_test, skipping precision, recall, f1 for class 4")
