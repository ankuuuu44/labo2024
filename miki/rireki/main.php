...
if(isset($_POST["Hesitate"])){
    ...
    header('Location: http://lmo.cs.inf.shizuoka.ac.jp/~miki/rireki/hesitate.php') ;
...
if(isset($_POST["StartTimeQ"])){
    ...
    header('Location: http://lmo.cs.inf.shizuoka.ac.jp/~miki/rireki/outlier2.php') ;
...
if($mode ==3){
        ...
        $sql ="select distinct linedata.UID from linedata,trackdata,AnswerQues 
    where linedata.WID=trackdata.WID and linedata.UID=trackdata.UID and linedata.UID=AnswerQues.UID and trackdata.UID=AnswerQues.UID
    and linedata.AID=AnswerQues.AID ".$term_rireki." ".$term_UID_ques." ".$search_ID_stu." order by linedata.UID"; 
...
<input type="submit" name="Hesitate" value="迷い分析">
<input type="submit" name="StartTime" value="問題別情報">
<input type="submit" name="DD" value="DD分析">
<input type="submit" name="linedatamouse" value="座標情報">
</form>
...
<input type="submit" name="exe" value="履歴参照">
<input type="submit" name="StartTimeQ" value="問題別情報">
</form>
