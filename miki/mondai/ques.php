...
<script type="text/javascript">
    ...
    function ButtonM_Click() {
        ...
        if (AID == 30) {
          ...
          //alert("一度右下の終了ボタンを押して書き込みを行ってください。");
          alert("一度右下の終了ボタンを押して書き込みを行ってください。(現在"+AID+"問終了)");
         return;
        }
    }
...
<!--
<label for="TermText"
		id="TermLabel" style="position:absolute;left:600px;top:320px;display:none">迷いの内容</label>
<input type="text" onkeyup="TermTextChange()" onChange="TermTextChange()" id="TermText" style="position:absolute;
	 left:600;top:340;font-size:12;display:none"/>
-->	 
<!--ダミー-->
-
