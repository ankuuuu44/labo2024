...
if(isset($_POST["idtxt"]) && isset($_POST["passtxt"])){
	...
	$_SESSION["URL"]="http://lmo.cs.inf.shizuoka.ac.jp/~miki/mondai/";
	...
	*/
	...
	if($count > 0){
		...
		//header("location: http://lmo.cs.inf.shizuoka.ac.jp/~miki/mondai/LineQuesForm.php");//本当のサーバー用
...
<A HREF="http://lmo.cs.inf.shizuoka.ac.jp/~miki/mondai/register/register.html">ユーザー新規登録</A><br><br>
