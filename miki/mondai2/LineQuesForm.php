...
function openwin() {
	...
	window.open("http://lmo.cs.inf.shizuoka.ac.jp/~miki/mondai/ques.php", "new", "width=861,height=700,resizable=0,menubar=0");
}
...
function openwin3() {
	...
	window.open("http://lmo.cs.inf.shizuoka.ac.jp/~miki/mondai/exam/exam.php", "new", "width=861,height=513,resizable=0,menubar=0");
