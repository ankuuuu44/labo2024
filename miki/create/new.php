...
<form action = "entry.php" method="post">
      <b>**　問題文　**</b><br>※日本語で入力して下さい。<br><br><input type="text" name="Japanese" size="50" ><br><br>
<b>**　英　文　**</b><br>※英語（半角）で入力して下さい。<br><br><input type="text" name="Sentence" size="50" style="ime-mode:disabled;"><br><br>
