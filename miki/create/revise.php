...
<form action = "part_select.php" method="post">
    <input type="submit" name="part" value="部分一致">
    <input type="submit" name="all" value="全文一致">
    <input type="submit" name="another" value="別解">
</form>
<br><br>

<font size = 4>
<b>修正を始める箇所を選択してください。</br></br></b>
</font>
...
echo "＞登録<br><br>";
echo "<a href=\"property.php\">難易度・文法項目編集</a>";
?>
</br>
<br>
<form action = "stop.php" method="post">
　　　<input type="submit" name="exe" value="修正を中止する">
</form>
