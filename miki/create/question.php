...
$sql_data = "select choose from set_question where TID =" .$TID.";";

$res = mysql_query($sql_data,$conn) or die("接続エラー");
$row = mysql_fetch_array($res,MYSQL_ASSOC);
$choose = $row["choose"];
//echo $choose;

$choose_num = explode(",",$choose);
$choose_count = count($choose_num);


$sql = "select count(*) as cnt from question_info 
        WHERE (open = 0 or author ='".$_SESSION["MemberName"]."') $term;";
}
//}
//print $sql;
echo "<br><br>";
...
if($_SESSION["manager"] == "0"){
?>
<input type="submit" value="出題問題決定" />
<?php
}
?>
<br>
...
<a href = "question.php">先頭ページに戻る</a>
</br>
<br>
