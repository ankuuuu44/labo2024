...
function jump(){
    location.href = "http://lmo.cs.inf.shizuoka.ac.jp/~miki/create/point_check_part.php";
}
...
<script type="text/javascript">
    ...
    function Button1_Click() {
        //終了条件チェック
        var $part_point = document.getElementById('PointSelect').options.value;
        //alert($part_point);
        
        if (Mylabels_ea.length == Mylabels2.length) {
        alert("部分一致であるので、全ての単語を指定することはできません");
        return;
        }
        ...
        */
        ...
        for (i = 0; i <= Mylabels_ea.length- 1; i++) {
